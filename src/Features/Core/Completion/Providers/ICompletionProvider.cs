...
namespace Microsoft.CodeAnalysis.Completion.Providers
{
    ...
    internal interface ICompletionProvider
    {
        ...
        /// </summary>
        Task<CompletionItemGroup> GetGroupAsync(Document document, int position, CompletionTriggerInfo triggerInfo, CancellationToken cancellationToken = default(CancellationToken));
        ...
        /// be dismissed.
        /// </summary>
        bool IsFilterCharacter(CompletionItem completionItem, char ch, string textTypedSoFar);
        ...
        /// semantics.
        /// </summary>
        TextChange GetTextChange(CompletionItem selectedItem, char? ch = null, string textTypedSoFar = null);
    }
}
