...
#If DEBUG Then
                Assert.Throws(Of XunitException)(Function() project.AddAnalyzerReference(analyzerReference2))
#End If
            End Using
        End Sub
...
#If DEBUG Then
                Assert.Throws(Of XunitException)(Function() project.AddAnalyzerReference(analyzerReference1))
#End If
            End Using
        End Sub
